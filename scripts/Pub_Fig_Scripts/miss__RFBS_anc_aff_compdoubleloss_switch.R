...

{
  ...
  dir_names=c("/Volumes/michael.landis/Active/Sean/RFBS/outfiles/anc_aff_sim/BSim_RFBS_DEC_comp50t_3nB_Exp0p5iter_1000000_Ncladooff_0_Nrateoff_0_f2n_clado_Rtre_2g_2l_1g_1l_2sw_dr_rf_gl_ds/",
              #"BSim_RFBS_DEC_comp50t_3nB_Exp1p0iter_1000000_f2n_clado_Rtre_2g_1g_1l_dr_rf_gl_ds",
              "/Volumes/michael.landis/Active/Sean/RFBS/outfiles/anc_aff_sim/BSim_RFBS_DEC_comp50t_3nB_Exp2p0iter_1000000_Ncladooff_0_Nrateoff_0_f2n_clado_Rtre_2g_2l_1g_1l_2sw_dr_rf_gl_ds/",
              ...
              "/Volumes/michael.landis/Active/Sean/RFBS/outfiles/anc_aff_sim/BSim_RFBS_DEC_comp500t_3nB_Exp0p5iter_1000000_Ncladooff_0_Nrateoff_0_f2n_clado_Rtre_2g_2l_1g_1l_2sw_dr_rf_gl_ds/",
              #"BSim_RFBS_DEC_comp500t_3nB_Exp1p0iter_1000000_f2n_clado_Rtre_2g_1g_1l_dr_rf_gl_ds",
              "/Volumes/michael.landis/Active/Sean/RFBS/outfiles/anc_aff_sim/BSim_RFBS_DEC_comp500t_3nB_Exp2p0iter_1000000_Ncladooff_0_Nrateoff_0_f2n_clado_Rtre_2g_2l_1g_1l_2sw_dr_rf_gl_ds/")
...
dir_ind=c(1,2,3,4,5,6)
#######plot affs########

{
  
  pdf(paste("miss_3_RFnon_boxplots.pdf", sep="/"),width = 18,height = 15)  
  
  par(mfrow=c(2,3), mai=rep(0.8,4))
...
###plot aff/occ#################################################
{
  ...
  pdf(paste("miss_3_aff_occ_acc_boxplots.pdf", sep="/"),width = 18, height = 15)  
  
  par(mfrow=c(2,3), mai=c(0.8,0.8,0.8,0.8))
