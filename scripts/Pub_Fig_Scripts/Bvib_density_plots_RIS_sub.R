...
newnew_RFBS_dir_names=  list.files() [(grep("Bvib_3nB_Exp0p5_29000",list.files()  ))]





#dir_names=c(newnew_RFBS_dir_names, new_RFBS_dir_names)

#nothing_dirs= dir_names[c(1,2)] 
...
dir_names[grep("germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss$", dir_names)]
...
dir_names= c(newnew_RFBS_dir_names, dir_names[grep("germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss$", dir_names)]
)
...
evidence_vec=c("admat", "incf","excf"  )
name_vec=c( "A","I", "E" )



RFBS_dir_names_sort=RFBS_dir_names


RFBS_dir_names_sort=sort(dir_names)

RFBS_dir_names= RFBS_dir_names_sort
...
RFBS_legend_names[[2]] = "No Data"

RFBS_legend_names #= RFBS_legend_names[c( 2,1,5, 6,3,4,7, 8)]

RFBS_dir_names = RFBS_dir_names[c(2,1, 3, 6, 4,7,5)]

RFBS_legend_order = c(8,2,1, 3, 6, 4,7,5)
...
RFBS_dir_names=c(
     "Bvib_3nB_Exp0p5_2900000_Foss_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
   , "Bvib_3nB_Exp0p5_2900000_Foss_admat_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"
   , "Bvib_3nB_Exp0p5_2900000_Foss_incf_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"   
   , "Bvib_3nB_Exp0p5_3000000_Foss_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
   , "Bvib_3nB_Exp0p5_3000000_Foss_excf_3.biomes.germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
   , "Bvib_3nB_Exp0p5_3000000_Foss_admat_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
   , "Bvib_3nB_Exp0p5_3000000_Foss_admat_excf_3.biomes.germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"  
   , "Bvib_3nB_Exp0p5_3000000_Foss_incf_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
   , "Bvib_3nB_Exp0p5_3000000_Foss_incf_excf_3.biomes.germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"  
   , "Bvib_3nB_Exp0p5_3000000_Foss_admat_incf_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
   , "Bvib_3nB_Exp0p5_3000000_Foss_admat_incf_excf_3.biomes.germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"  
...
RFBS_dir_names=c(
  ...
  , "Bvib_3nB_Exp0p5_3000000_Foss_admat_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
  , "Bvib_3nB_Exp0p5_3000000_Foss_admat_excf_3.biomes.germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"  
  , "Bvib_3nB_Exp0p5_3100000_Foss_incf_excf_3.biomes.germination.only.leafing.conservative_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
  , "Bvib_3nB_Exp0p5_3100000_Foss_incf_excf_3.biomes.germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"  
  , "Bvib_3nB_Exp0p5_3100000_Foss_admat_incf_excf_3.biomes.germination.only.leafing.conservative_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
  , "Bvib_3nB_Exp0p5_3100000_Foss_admat_incf_excf_3.biomes.germination.only.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"  
...
#
#RFBS_dir_names=c("Bvib_3nB_Exp0p5_3100000_Foss_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss" 
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_admat_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"   
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_incf_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"   
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"           
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_excf_3.biomes.germination.bold.leafing.bold.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"           
#                 
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_admat_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"     
#                 
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_admat_excf_3.biomes.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"                  
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_admat_incf_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"     
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_incf_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"      
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_incf_excf_3.biomes.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"                   
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_admat_incf_excf_3.biomes.germination.only.leafing.conservative.USDA_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"
#          
#                 ,"Bvib_3nB_Exp0p5_3100000_Foss_admat_incf_excf_3.biomes.germination.bold.leafing.bold_eco_allo_clado_2g_1g_1l_rf_gl_ds_Foss"             
#)
...
RFBS_legend_names=RFBS_legend_names_exc

RFBS_legend_names=c("Prior", "None", "A", "I", "Ec", "Eb", "AI", "A_Ec", "A_Eb","I_Ec", "I_Eb", "A_I_Ec", "A_I_Eb")

RFBS_legend_names=c("Prior", "None", "A", "I", "Ec", "Eb", "AI", "A_Ec", "A_Eb","I_Ec", "I_Eb", "A_I_Ec", "A_I_Eb")

RFBS_legend_names=c("Prior", "None", "A", "Ic","Ib", "Ec", "Eb", "AIc", "AIb", "A_Ec", "A_Eb","Ic_Ec", "Ic_Eb", "Ib_Ec", "Ib_Eb", "A_Ic_Ec", "A_Ic_Eb", "A_Ib_Ec", "A_Ib_Eb")
...
#tree=read.tree("viburnum_data_files/out.1.t163.f5.mask_fossil_states.mcc.tre")
...
{
  pdf(paste("~/Projects/realfun_Biome/new_EXP_0p5_bvib_RFBS_DEC_traces.pdf", sep=""),width = 8,height = 15)
  #
  #  
  for (dir in (1:length(RFBS_chains))){
    ...
    print(dir)
      ...
      for (run in 1:length(RFBS_chains[[dir]])){
        ...
        if(length(grep("iter", RFBS_chains_full[[dir]][[run]][,1]))>0 ){
          
          RFBS_chains_full[[dir]][[run]] = RFBS_chains_full[[dir]][[run]][ceiling((max(grep("iter", RFBS_chains_full[[dir]][[run]][,1]))+1):chain_length),]
          RFBS_chains_full[[dir]][[run]] = apply(RFBS_chains_full[[dir]][[run]], 2, as.numeric)  
        }
        
        chain_length=nrow(RFBS_chains_full[[dir]][[run]])
        
        RFBS_chains[[dir]][[run]] = RFBS_chains_full[[dir]][[run]][ceiling((chain_length*burnin)):chain_length,]
      ...
      for (chain in 1:length(chain_ind_vec)){
       ...
       plot(RFBS_chains[[dir]][[run]][,chain_list[[chain]]], type = "l", xlab = "", ylab="")
        for (run in 1:length(RFBS_chains[[dir]])){
...
pdf(paste("conservative_I_3correctIEA_rescaled_EXP_0p5_bvib_RFBS_DEC_density.pdf", sep=""),width = 8,height = 10)
...

{
  ...
  pdf(paste("~/Projects/realfun_Biome/Pub_Fig_Scripts/conserv_I_3biome_bold_consv_EXP_0p5_bvib_RFBS_density_violin.pdf", sep=""),width = 10,height = 10)
  ...
  #col_vec=c("grey", "gray31" ,"blue4","yellow3", "red4", "orange2", "purple4", "chocolate4")
#
  #col_vec=c("blue4", "gray31" ,"yellow3", "purple4", "chocolate4","red4", "orange2")
  #
...
{
  {
   ...
   # par(oma = c(4,1,1,1), mfrow = c(4, 2), mar = c(2, 2, 2, 2))
    ...
    for (z in 1:8){
      ...
      ymax= c(1.0, 2.5, 2.0, 1.5, 0.25, 1.0,1.0,1.0)
      ymax= c(2.5, 2.5, 2.5, 2.5, 2.5, 1.0,1.0,1.0)
      ...
      #dists=cbind(do.call(cbind, c(sample(unlist(prior_chain), size = min_dist_size, replace=F),    
      #                             lapply(1:length(RFBS_chains), function(dir) sample(as.numeric(RFBS_post_dist[[dir]][[chain]]), size = min_dist_size, replace=F) ) ) ))
      
      #sample(unlist(prior_chain), size = min_dist_size, replace=F)
    ...
    #     col = col_vec[RFBS_legend_order], lwd = 10, xpd = TRUE, cex = 2, seg.len=0.25,ncol = 4, bty = 'n')
    #legend('bottom',
    #       legend = RFBS_legend_names, 
    #       col = col_vec, lwd = 10, xpd = TRUE, cex = 2, seg.len = 0.25, ncol = 5, bty = 'n')
