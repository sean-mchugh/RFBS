...

{
  ...
  dir_names=c("/Volumes/michael.landis/Active/Sean/RFBS/outfiles/sim/resub/coverage/BSim_RFBS_DEC_comp50t_3nB_Exp0p5iter_1000000_Ncladooff_0_Nrateoff_0_f2n_clado_Rtre_2g_2l_1g_1l_2sw_dr_rf_gl_ds/",
...

{
  ...
  pdf(paste("~/Projects/RFBS-main/outfiles/sim_plots/resub/coverage/3_RFnon_boxplots.pdf", sep="/"),width = 15,height = 15)  
...
###plot aff/occ#################################################
{
  ...
  pdf(paste("~/Projects/RFBS-main/outfiles/sim_plots/resub/coverage/3_aff_occ_acc_boxplots.pdf", sep="/"),width = 15,height = 15)  
